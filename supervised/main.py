...
model_names = ["resnext29_8_64", "resnext29_16_64", 'resnet18', 'resnet34', 'resnet50', 'resnet101', 'resnet152',
               'preactresnet18', 'preactresnet34', 'preactresnet50', 'preactresnet101', 'preactresnet152',
               'caffe_cifar', 'densenet100_12','densenet100_24', 'wrn28_10', 'wrn28_2']
# print(model_names)
...
def main():
    ...
    if args.adv_unpre:
        ...
        train_loader, valid_loader, _, test_loader, num_classes = load_data_subset(args.data_aug, args.batch_size, 2,
                                                                                   ...
                                                                                   preprocess, no_jsd=args.no_jsd,
                                                                                   augmix=args.do_augmix,
                                                                                   labels_per_class=args.labels_per_class,
                                                                                   valid_labels_per_class=args.valid_labels_per_class)
